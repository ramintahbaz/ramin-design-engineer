...
const mediaItems = [
  { id: '1', type: 'image' as const, src: '/images/doritos/SPLASH.jpg' },
  { id: '2', type: 'image' as const, src: '/images/doritos/Doritos_Loaded_VIS_FINAL copy_Page_1.png' },
  { id: '3', type: 'video' as const, src: '/images/doritos/231215_The-Garage_Doritos_S01_1x1_H264.mp4' },
  { id: '4', type: 'video' as const, src: '/images/doritos/231215_The-Garage_Doritos_S03_1x1_H264.mp4' },
  { id: '5', type: 'image' as const, src: '/images/doritos/DOR001_PBD_Shot_33_V2_4x5.jpg' },
];

const SWIPE_THRESHOLD = 15;
const HORIZONTAL_RATIO = 1.2;

export default function DoritosEmbed() {
  ...
  return (
    <div className="w-full">
      <div
        ...
        style={{ aspectRatio: '4/5', backgroundColor: 'transparent', touchAction: 'pan-y', ...cursorStyle }}
